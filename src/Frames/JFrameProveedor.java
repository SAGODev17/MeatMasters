...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel12.setText("GESTIÓN DE PROVEEDORES");
...
public boolean isCellEditable(int row, int column) {
        ...
        switch (busqueda) {
            case 0 -> {
                SqlMostrarT = "SELECT * FROM PROVEEDOR WHERE  PNOM_PROVEEDOR  LIKE '%" + jTextFieldBnombre.getText() + "%' ORDER BY PNOM_PROVEEDOR";
            }
            case 1 -> {
                if (jTextFieldBcedula.getText().length() >= 8) {
                    SqlMostrarT = "SELECT * FROM PROVEEDOR WHERE CC_PROVEEDOR= " + jTextFieldBcedula.getText() + " ORDER BY PNOM_PROVEEDOR";
                } else {
            ...
            case 2 ->
                SqlMostrarT = "SELECT * FROM PROVEEDOR ORDER BY PNOM_PROVEEDOR";
        }
        try {
            ...
            if (ConeBD.RstBD != null && ConeBD.RstBD.next()) {
                do {
                    ...
                    DatCliente[2] = ConeBD.RstBD.getString("SNOM__PROVEEDOR");
                    DatCliente[3] = ConeBD.RstBD.getString("PAPE_PROVEEDOR");
                    DatCliente[4] = ConeBD.RstBD.getString("SAPE_PROVEEDOR");
                    DatCliente[5] = ConeBD.RstBD.getString("CELULAR_PROVEEDOR");
                    DatCliente[6] = ConeBD.RstBD.getString("DIRECCION_PROVEEDOR");
    ...
    public void guardarCliente() {
        ...
        try {
            sqlGuardarCliente = "INSERT INTO PROVEEDOR VALUES (" + jTextFieldCC.getText() + ",'" + jTextNombreP.getText() + "','" + jTextNombreS.getText() + "','" + jTextFieldApellidoP.getText() + "','" + jTextFieldApellidoS.getText() + "'," + jTextFieldCeluar.getText() + ",'" + jTextFieldDireccion.getText() + "')";
    ...
    public void editarCliente() {
        ...
        try {
            SqlEditarCliente = "UPDATE PROVEEDOR SET PNOM_PROVEEDOR = '" + jTextNombreP.getText() + "', SNOM__PROVEEDOR = '" + jTextNombreS.getText() + "',"
                    + " PAPE_PROVEEDOR = '" + jTextFieldApellidoP.getText() + "', SAPE_PROVEEDOR= '" + jTextFieldApellidoS.getText() + "', CELULAR_PROVEEDOR =" + jTextFieldCeluar.getText() + ""
                    + ", DIRECCION_PROVEEDOR = '" + jTextFieldDireccion.getText() + "' WHERE CC_PROVEEDOR = " + jTextFieldCC.getText();
    ...
    public void eliminarCliente() {
        ...
        try {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "¿Está seguro de eliminar al proveedor?", "Confirmación de eliminación", JOptionPane.YES_NO_OPTION);
            if (confirmacion == JOptionPane.YES_OPTION) {
                JOptionPane.showMessageDialog(rootPane, "Cliente " + jTextNombreP.getText() + " eliminado exitosamente.");
                sqlEliminarCo = "DELETE FROM PROVEEDOR WHERE CC_PROVEEDOR  = " + jTextFieldCC.getText();
    ...
    private void TablaProveedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaProveedorMouseClicked
        ...
        jTextFieldCC.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna0)));
        jTextNombreP.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna1)));
        jTextNombreS.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna2)));
        jTextFieldApellidoP.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna3)));
        jTextFieldApellidoS.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna4)));
        jTextFieldCeluar.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna5)));
        jTextFieldDireccion.setText(String.valueOf(this.TablaProveedor.getValueAt(fila, Columna6)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameProveedor.class  
